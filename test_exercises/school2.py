...
add_student("Luca", "Bombardelli")
add_student("Luca", "Brecher")
add_student("Berke", "Erdik")
add_student("Marcel", "Hager")
add_student("Luka", "Jandrić")
add_student("Tobias", "Krismer")
add_student("Dominik", "Lechner")
add_student("Emanuel", "Mair")
add_student("Leon", "Pezzei")
add_student("Thomas", "Schmid")
add_student("Lucas", "Tusch")
print_student_data_except("Doe")
